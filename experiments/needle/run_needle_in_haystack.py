...
class LLMNeedleHaystackTester:
    ...
    def __init__(self,
        ...
        self.expected_response = [
            # llama3 prefer to ans the first one
        ...
        criti_config(self.model_to_test,
    ...
    def evaluate_and_log(self, context, context_length, depth_percent):
        ...
        if len(response) != 0:
            for ans in self.expected_response:
                score = max(score, scorer.score(ans, response)['rouge1'].fmeasure*10)
    ...
    def read_context_files(self):
        ...
        while self.get_context_length_in_tokens(context) < max_context_length:
            for file in glob.glob(f"{self.haystack_dir}/*.txt"):
                print(self.get_context_length_in_tokens(context))
