...
from criti_prefill.ops import eattention
...
def llama_eattention_forward(
    ...
    **kwargs,
    ...
    if self.layer_idx + 1 > self.layer_skip and do_eattn:
        ...
        attn_output = eattention(self, segment_size, threshold_len, budgets, block_size, query_states, key_states, value_states)
    else:
